...
Shader "Toon Shaders/Fixed (XZ) + Animated"
{
    Properties
    {
        ...
        [Space] _MovingVector ("Moving", Vector) = (0.0, 0.0, 0.0, 0.0)
    }
    SubShader
    {
        Tags
        ...
        { 
            ...
            {
                half4 texColor = tex2D(_MainTex, i.uv + sin(_MovingVector * _Time)) * _Color;
